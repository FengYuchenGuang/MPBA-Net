...
from .BAAG_BCA import BoundaryAwareAttentionGateAtrous2D, BoundaryAwareAttentionGateAtrous1D, BoundaryAwareAttentionGate2D, BoundaryAwareAttentionGate1D
...
class BoundaryAwareTransformerEncoderLayer(TransformerEncoderLayer):
    "Add BAAG to Transformer Encoder"
